...
@Data
public class RecordParserContext<T> {
    ...
    public RecordParserContext(String channel, Mail mail, PasswordHelper passwordHelper) {
        this.mail = mail;
    ...
    public String getPassword() {
        String password = this.passwordHelper.getPassword(this.channel, mail.getDate().getTime(), mail.getAttachmentFileName());
        if (password == null) {
